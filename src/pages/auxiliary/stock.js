...
const AddStockForm = Form.create({ name: 'update-pw-form-modal' })(
  ...
  class extends React.Component {
    ...
    render() {
      const { visible, onCancel, onCreate, form,code,name,specs,unit } = this.props;
  ...
  handleAddOk=e=>{
    ...
    const {columns,selectedRowKeys } = this.state;
      ...
      onChange: this.onSelectChange,
        ...
        <PageHeader title="存货列表"/>
        <div className="header-operation">
          {ShowMenuFilter('/role/add')?<Button type="primary" onClick={this.handleAddStock}>添加存货</Button>:''}
        </div>
