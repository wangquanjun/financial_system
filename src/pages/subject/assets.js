...
import {auxiliaryFilter,directionFilter,categoryFilter} from './subjectFilter';
const { Option } = Select;
          ...
          <Form {...formItemLayout}>
            ...
            <Form.Item label="科目类别">
              {getFieldDecorator('category',{
                ...
                <Select>
                  <Option key="1" value="1">流动资产</Option>
                  <Option key="2" value="2">非流动资产</Option>
                </Select>
              )}
            </Form.Item>
	...
	constructor(props){
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: 'category',
          render:(text, record, index)=>{
            return <div>{categoryFilter(text)}</div>
          }
        },
        {
          title: '余额方向',
