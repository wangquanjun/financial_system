...
import {auxiliaryFilter,directionFilter,categoryProfitandlossFilter} from './subjectFilter';
const { Option } = Select;
          ...
          <Form {...formItemLayout}>
            ...
            <Form.Item label="科目类别">
              {getFieldDecorator('category',{
                ...
                <Select>
                  <Option key="1" value="1">营业收入</Option>
                  <Option key="2" value="2">期间费用</Option>
                  <Option key="3" value="3">其它损失</Option>
                  <Option key="4" value="4">营业成本及税金</Option>
                  <Option key="5" value="5">以前年度损益调整</Option>
                  <Option key="6" value="6">所得税</Option>
                  <Option key="7" value="7">其它收益</Option>
                </Select>
              )}
            </Form.Item>
	...
	constructor(props){
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: 'category',
          render:(text, record, index)=>{
            return <div>{categoryProfitandlossFilter(text)}</div>
          }
        },
        {
          title: '余额方向',
