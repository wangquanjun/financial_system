...
import {auxiliaryFilter,directionFilter,categoryCostFilter} from './subjectFilter';
const { Option } = Select;
          ...
          <Form {...formItemLayout}>
            ...
            <Form.Item label="科目类别">
              {getFieldDecorator('category',{
                ...
                <Select>
                  <Option key="1" value="1">成本</Option>
                </Select>
              )}
            </Form.Item>
	...
	constructor(props){
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: 'category',
          render:(text, record, index)=>{
            return <div>{categoryCostFilter(text)}</div>
          }
        },
        {
          title: '余额方向',
